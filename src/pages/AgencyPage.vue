    ...
    <div @mousemove="onMousemove" :style="{ backgroundColor: `hsl(${x}, 80%, 50%)` }"
        ...
        <div class="container flex flex-row justify-between items-center px-3 ">
            ...
            <div class=" basis-1/2 flex justify-center items-center align-middle">
                <img class="object-fill h-60 w-100" src="@/assets/img/security10.gif" />
            </div>
        </div>
    </div>
    <!-- Design Section end -->
    ...
    <section class="bg-white ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-bold text-aqua">Our Team</h2>
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div
                    ...
                    <div class="p-5 ">
                        ...
                        <span class="text-gray-500 dark:text-gray-400">Sales Executive</span>
