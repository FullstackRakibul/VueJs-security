    ...
    <div @mousemove="onMousemove" :style="{ backgroundColor: `hsl(${x}, 80%, 50%)` }"
        ...
        <div class="container flex flex-row justify-between items-center px-3 ">
            <div class=" basis-1/2 p-1 mx-2  text-white">
                ...
                <p class="">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Hic dolores, obcaecati ipsum quasi
                    molestias debitis!</p>
            </div>
    ...
    <div class="container mx-auto px-20">
        ...
        <div style='background-color:rgb(255, 255, 255)'>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4 lg:pt-10 lg:pb-10" style="cursor: auto;">
                ...
                <div class="p-6 bg-gray-100 rounded-lg hover:shadow-md" style="cursor: auto;">
...
<!--..................................-->
  ...
  <!-- Main modal -->
  <div id="defaultModal" data-bs-backdrop="true" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex" aria-modal="true" role="dialog">
