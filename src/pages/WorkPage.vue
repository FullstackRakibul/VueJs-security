...
<template>
  ...
  <!-- Breadcrumb -->
  <!-- <nav class=" head mb-4 flex px-5 py-3 text-gray-700 rounded-sm bg-gray-25 dark:border-gray-700"
  ...
  >
    <div class="container flex flex-row justify-between items-center px-3">
      <div class="basis-1/2 p-1 mx-2 text-white">
        <h2 data-text="What do we do ?" class="text-5xl">What do we do ?</h2>
        <p class="">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Hic dolores,
          obcaecati ipsum quasi molestias debitis!
        </p>
      </div>
      <div class="basis-1/2 flex justify-center items-center align-middle">
        <img class="object-fill h-60 w-100" src="@/assets/img/security3.gif" />
      </div>
    </div>
  </div>
  <!-- Design Section end -->
    ...
    <div style="background-color: rgb(255, 255, 255)">
      ...
      >
        <div class="p-6 bg-gray-100 rounded-lg hover:shadow-md">
          ...
          <h3 class="text-lg font-bold mb-2">1. UI/UX</h3>
        ...
        <div class="p-6 bg-gray-100 rounded-lg hover:shadow-md">
          <div class="mb-5">
            <svg
              class="hi-outline hi-cube inline-block w-12 h-12 text-indigo-500"
              stroke="currentColor"
              fill="none"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <h3 class="text-lg font-bold mb-2">2. Design</h3>
        ...
        <div
          class="p-6 bg-gray-100 rounded-lg hover:shadow-md"
          style="cursor: auto"
        >
          <div class="mb-5" style="cursor: auto">
            <svg
              class="hi-outline hi-cog inline-block w-12 h-12 text-indigo-500"
              stroke="currentColor"
              fill="none"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <h3 class="text-lg font-bold mb-2">3. Implements</h3>
        ...
        <div class="p-6 bg-gray-100 rounded-lg hover:shadow-md">
          ...
          <h3 class="text-lg font-bold mb-2">4. Debug</h3>
