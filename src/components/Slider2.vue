<template>
    <section class="rounded shadow-sm p-3 h-full bg-blue-700 flex flex-col justify-center ">
        <div class="flex flex-col items-start gap-2">
            <span class="inline-block bg-slate-50 text-slate-800 rounded-sm p-2 m-2 ">moz://a</span>
            <h2 class="text-emerald-600 text-3xl font-semibold">This is Third Slider</h2>
